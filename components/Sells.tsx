...
//   const color = (theme==="system")? userTheme()==='dark'?"#fff":"#000":(theme==='dark')?"#fff" :"#000";
  ...
  return (
    <div className="w-full h-80 pb-12 text-black" >
      <h4 >Sales Chart - between {props.salesData === undefined || props.totalLength === 0 ? "No Date" : props.startDate} and  {props.salesData === undefined || props.totalLength === 0 ? "No Date" : props.endDate}</h4>
