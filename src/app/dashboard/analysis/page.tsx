        ...
        <>
            ...
            <div className="w-full h-full bg-slate-200 text-black px-2" >
                <div className='w-fit flex items-center justify-between my-1'>
                  ...
                  <label htmlFor="stdate" className='mr-4'>Start date</label>  <input type="date" name="stdate" onChange={(e:React.ChangeEvent<HTMLInputElement>)=> setStartDate(e.target.value)} defaultValue={startDate}  className='border border-black text-black'/>
                  <label htmlFor="endate" className='ml-4'>End date</label>
                    <input type="date" name="endate" onChange={(e:React.ChangeEvent<HTMLInputElement>)=> setEndDate(e.target.value)}  defaultValue={endDate} className='border border-black text-black ml-2' />
